...
if (isset($_POST['submit']))
{
    ...
    {
        echo " This email already used<br>";
    }*/
    ...
    else
    {
       ...
       // }
        ...
        $obj->insert_admin(
            $conobj,
            $_POST['username'],
            $_POST['email'], // Only sanitize email
            $_POST['password'], // Securely hash the password
            $_POST['phone_number'],
            $_POST['role'],
            $_POST['gender'],
            $_POST['national_id'],
            $_POST['date_of_birth'],
            $_POST['joining_date'], // Fixed duplicate field
