        ...
        <fieldset>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="file" id="profile_picture" name="profile_picture" value = '<?php echo $_SESSION['pp']; ?>'>
                        <?php if (isset($_SESSION['pp']) && !empty($_SESSION['pp'])): ?>
                            <br><img src="<?php echo $_SESSION['pp']; ?>" alt="Current Profile Picture" width="100">
                        <?php endif; ?>
                    </td>
                </tr>
...
<?php
include('../control/editprofile_control.php');
?>